...
async def main():
    ...
    logo_success = await test_webhook(
        ...
        payload={
            'job_id': 'test-1234511',
            'logo_url': 'https://vlxubllxerfeiieuiasl.supabase.co/storage/v1/object/sign/catalog-assets/logos/001/logo_001.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85MDYzZjE4YS04MjAxLTRkMDUtYTFiMS0zMjZlMjJlMGM0ZTkiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJjYXRhbG9nLWFzc2V0cy9sb2dvcy8wMDEvbG9nb18wMDEucG5nIiwiaWF0IjoxNzYwMjA3NDc4LCJleHAiOjE3NjA4MTIyNzh9.OxyKo7ixN38cmXsRNBAtj1qTHnjOSz8xMzOO48-2ClE'
        }
    )
    ...
    page_success = await test_webhook(
        ...
        payload={
            'job_id': 'test-1234511',
            'item': 'sweat-sem-capuz',
            'color': 'preto',
            'logo_large_url': 'https://vlxubllxerfeiieuiasl.supabase.co/storage/v1/object/sign/catalog-assets/logos/003/large.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85MDYzZjE4YS04MjAxLTRkMDUtYTFiMS0zMjZlMjJlMGM0ZTkiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJjYXRhbG9nLWFzc2V0cy9sb2dvcy8wMDMvbGFyZ2UucG5nIiwiaWF0IjoxNzYwMjA3MjE0LCJleHAiOjE3NjA4MTIwMTR9.rC1vRrZSR_N1LLV-4bjB442FafhV8hscbp5CHOaf8-g',
            'logo_small_url': 'https://vlxubllxerfeiieuiasl.supabase.co/storage/v1/object/sign/catalog-assets/logos/003/small.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85MDYzZjE4YS04MjAxLTRkMDUtYTFiMS0zMjZlMjJlMGM0ZTkiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJjYXRhbG9nLWFzc2V0cy9sb2dvcy8wMDMvc21hbGwucG5nIiwiaWF0IjoxNzYwMjA3MjI1LCJleHAiOjE3NjA4MTIwMjV9.lvgDJ8oH4Dq9I9-ifPZtbv6CmRN5Nx6cAYyRFI5JNow'
        }
    )
